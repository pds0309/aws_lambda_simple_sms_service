...
1 데이터명 : 공공데이터활용지원센터_보건복지부 코로나19 감염 현황



2 변경내용 :  ACC_EXAM_CNT(누적 의심신고 검사자수), ACC_DEF_RATE(누적확진률) 제공중지.



3. 변경사유 : 해당 항목 수집불가로 인한 제공중지(질병관리청)
...
> ACC_DEF_RATE : 21.11.24 이후 제공중지

> ACC_EXAM_CNT : 22.02.09 이후 제공중지

> 22.02.09 이전날짜의 데이터라도 2.9일 이후 해당일자의 데이터수정으로 인한 업데이트시 해당항목 삭제 후 제공됨.

---


**공공데이터에서 검사자 수 제공을 중지하여 메시지 전송 실패되던 부분 수정**
